...
class CandidatureController extends Controller {
    ...
    public function apply() {
        ...
        if (!isset($_GET['offre_id'])) {
            header("Location:  $BASE_URL./index.php?controller=offre&action=list");
            exit();
        }
            ...
            if (isset($_FILES['cv']) && $_FILES['cv']['error'] == 0) {
                ...
                if (move_uploaded_file($_FILES['cv']['tmp_name'], $uploadFile)) {
                    ...
                    if ($stmt->execute([
                        ...
                        header("Location:  $BASE_URL./index.php?controller=candidature&action=list");
                        exit();
                    } else {
    ...
    public function wishlistAdd() {
        ...
        header("Location:  $BASE_URL./index.php?controller=candidature&action=wishlistList");
        exit();
    }
