...
<body>
  <header class="dashboard-header">
    <div class="container header-content">
      <div class="logo"><a href="<?= BASE_URL ?>/public/index.php">MyInternship</a></div>
      <nav class="nav-menu">
        <ul>
          <li><a href="<?= BASE_URL ?>/public/index.php?controller=dashboard&action=student">Tableau de bord</a></li>
          <li><a href="<?= BASE_URL ?>/public/index.php?controller=offre&action=list">Offres</a></li>
          <li><a href="<?= BASE_URL ?>/public/index.php?controller=candidature&action=list">Mes candidatures</a></li>
          <li><a href="<?= BASE_URL ?>/public/index.php?controller=profile&action=view">Profil</a></li>
          <li><a href="<?= BASE_URL ?>/public/index.php?controller=entreprise&action=eval">Entreprises</a></li>
          <li><a href="<?= BASE_URL ?>/public/index.php?controller=offre&action=list">Offres de stage</a></li>
          <li><a href="<?= BASE_URL ?>/public/index.php?controller=candidature&action=wishlist">Wish-list</a></li>
  ...
  <div class="dashboard-container container">
    <aside class="sidebar">
      <ul>
        <li><a href="<?= BASE_URL ?>/public/index.php?controller=candidature&action=list">Mes candidatures</a></li>
        <li><a href="<?= BASE_URL ?>/public/index.php?controller=stage&action=current">Mes stages en cours</a></li>
        <li><a href="<?= BASE_URL ?>/public/index.php?controller=stage&action=history">Historique</a></li>
        <li><a href="<?= BASE_URL ?>/public/index.php?controller=message&action=list">Messages</a></li>
      </ul>
    </aside>
