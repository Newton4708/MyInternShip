...
<body>
  <header class="dashboard-header">
    <div class="container header-content">
      ...
      <nav class="nav-menu">
        <ul>
          <li><a href="<?= BASE_URL ?>/public/index.php?controller=dashboard&action=admin">Dashboard</a></li>
          <li><a href="<?= BASE_URL ?>/public/index.php?controller=entreprise&action=index">Entreprises</a></li>
          <li><a href="<?= BASE_URL ?>/public/index.php?controller=offre&action=index">Offres</a></li>
          <li><a href="<?= BASE_URL ?>/public/index.php?controller=user&action=index">Utilisateurs</a></li>
  ...
  <div class="dashboard-container container">
    <aside class="sidebar">
      <ul>
        <li><a href="<?= BASE_URL ?>/public/index.php?controller=dashboard&action=admin">Résumé</a></li>
        <li><a href="<?= BASE_URL ?>/public/index.php?controller=dashboard&action=stats">Statistiques globales</a></li>
        <li><a href="<?= BASE_URL ?>/public/index.php?controller=entreprise&action=index">Gestion entreprises</a></li>
        <li><a href="<?= BASE_URL ?>/public/index.php?controller=offre&action=index">Gestion offres</a></li>
        <li><a href="<?= BASE_URL ?>/public/index.php?controller=user&action=index">Gestion utilisateurs</a></li>
      </ul>
    </aside>
