...
<body>
    ...
    <?php endif; ?>
    <form method="POST" action="<?= BASE_URL ?>/public/index.php?controller=entreprise&action=edit&id=<?= htmlspecialchars($entreprise['id']) ?>">
    ...
    <br>
    <a href="<?= BASE_URL ?>/public/index.php?controller=entreprise&action=list">Retour à la liste</a>
</body>
</html>
