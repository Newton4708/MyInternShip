...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>/public/assets/globals.css" />
    <link rel="stylesheet" href="<?= BASE_URL ?>/public/assets/styleguide.css" />
...
<body>
    <header class="site-header">
      <div class="container header-content">
        <div class="logo">
          <a href="<?= BASE_URL ?>/public/index.php?controller=home&action=index">MyIntership</a>
        </div>
        <nav class="nav-menu">
          <ul>
            <li><a href="<?= BASE_URL ?>/public/">Accueil</a></li>
