...
<body>
    ...
    <?php endif; ?>
    <form method="POST" action="<?= BASE_URL ?>/public/index.php?controller=candidature&action=apply&offre_id=<?= htmlspecialchars($offre_id) ?>" enctype="multipart/form-data">
    ...
    <br>
    <a href="<?= BASE_URL ?>/public/index.php?controller=offre&action=list">Retour aux offres</a>
</body>
</html>
