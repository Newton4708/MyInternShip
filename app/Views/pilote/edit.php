...
<body>
    ...
    <?php endif; ?>
    <form method="POST" action="<?= BASE_URL ?>/public/index.php?controller=pilote&action=edit&id=<?= htmlspecialchars($pilot['id']) ?>">
    ...
    <br>
    <a href="<?= BASE_URL ?>/public/index.php?controller=pilote&action=list">Retour à la liste</a>
</body>
</html>
